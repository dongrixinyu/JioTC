...
class BaseEmbedding(object):
    ...
    def info(self) -> Dict:
        return {
            ...
            'embed_model': json.loads(self.embed_model),
        }
    ...
    def analyze_corpus(self,
        ...
        """
        Prepare embedding layer and pre-processor for labeling classification
    ...
    def process_x_dataset(self, data, subset=None):
        #                  data,#: List[List[str]],
        #                  subset=None) -> np.ndarray#: Optional[List[int]] = None) -> np.ndarray
        """
